...
OWNER_NUMBER: process.env.OWNER_NUMBER || "923172149013", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "crazyTech", // Input Yours custom...(Maintain font for Flow)
